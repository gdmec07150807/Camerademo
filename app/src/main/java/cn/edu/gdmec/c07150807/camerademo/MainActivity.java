package cn.edu.gdmec.c07150807.camerademo;
...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    camera=Camera.open();
    android.hardware.Camera.Parameters params=camera
            .getParameters();
        //拍照时自动对焦
    ...
    public void savePicture(byte[] data){
        try {
            //图片id
        String imaeId=System.currentTimeMillis()+"";
            //相片保存路径
